...
// Define dashboard-specific navigation params
...
// Combine with main navigation params
type NavigationProps = NativeStackNavigationProp<RootStackParamList & DashboardStackParamList>;

// Icon components (replace with react-native-vector-icons in production)
...
export default function Dashboard() {
  ...
  const handleActionPress = (route: keyof DashboardStackParamList) => {
            ...
            <View style={styles.actionsGrid}>
              {actions.map((action) => (
                <TouchableOpacity
                  ...
                  onPress={() => handleActionPress(action.route as keyof DashboardStackParamList)}
                  activeOpacity={0.7}
                >
